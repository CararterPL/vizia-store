          ...
          <div className="relative w-full max-w-2xl h-full lg:h-auto lg:max-h-[90vh] bg-zinc-950 border-x lg:border border-white/10 overflow-y-auto scrollbar-hide">
            ...
            <div className="sticky top-0 z-10 bg-zinc-950/80 backdrop-blur-md p-6 border-b border-white/10 flex justify-between items-center">
              <div>
                ...
                <p className="font-mono text-[8px] text-zinc-400 uppercase tracking-widest mt-1">Ref_ID: VN-360-GP-SIZE</p>
              </div>
            ...
            <div className="p-6 lg:p-10 space-y-12">
              ...
              {/* 1. SCHEMAT (PIONOWO) */}
              <div className="space-y-4">
                <span className="font-mono text-[9px] text-zinc-300 uppercase tracking-widest border-l-2 border-vizia-red pl-3">01_Visual_Matrix</span>
              ...
              {/* 2. TABELA (PIONOWO) */}
              <div className="space-y-4">
                <span className="font-mono text-[9px] text-zinc-300 uppercase tracking-widest border-l-2 border-vizia-red pl-3">02_Dimension_Table</span>
